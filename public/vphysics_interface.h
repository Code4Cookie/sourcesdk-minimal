...
{
public:
	virtual ~IPhysicsObject( void ) {} // 0
	virtual bool			IsStatic() const = 0; // 1
	virtual bool			IsAsleep() const = 0; // 2
	virtual bool			IsTrigger() const = 0; // 3
	virtual bool			IsFluid() const = 0; // 4
	virtual bool			IsHinged() const = 0; // 5
	virtual bool			IsCollisionEnabled() const = 0; // 6
	virtual bool			IsGravityEnabled() const = 0; // 7
	virtual bool			IsDragEnabled() const = 0; // 8
	virtual bool			IsMotionEnabled() const = 0; // 9
	virtual bool			IsMoveable() const = 0; // 10
	...
	virtual void			SetGameIndex( unsigned short gameIndex ) = 0; // 20
	...
	virtual float			GetInvMass( void ) const = 0; // 30
	...
	virtual unsigned int	GetContents() const = 0; // 40
	...
	virtual void			SetVelocityInstantaneous( const Vector *velocity, const AngularImpulse *angularVelocity ) = 0; // 50
	virtual void			UNKNOWN1() = 0; // 51
	virtual void			GetVelocity( Vector *velocity, AngularImpulse *angularVelocity ) const = 0; // 52
	virtual void			AddVelocity( const Vector *velocity, const AngularImpulse *angularVelocity ) = 0; // 53
